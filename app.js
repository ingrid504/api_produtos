...
// Configurar o body-parser para lidar com JSHON;
...
const db = mysql.createConnection({
    host: 'localhost',
    user: 'root',
    password: '', // Substituir pela senha do seu banco de dados
...
app.post('/produtos', (req, res) => {
    ...
    db.query(sql, [nome, descricao, preco, estoque], (err, result) => {
         if (err) {
            ...
            return res.status(500).json({ message: 'Erro ao inseri o produto.' });
         }
...
// Iniciar o servidor
app.listen(port, () => {
    console.log(`Servidor rodeando em http://localhost:${port}`);
});